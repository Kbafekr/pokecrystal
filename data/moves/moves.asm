...
; entries correspond to move ids (see constants/move_constants.asm)
	...
	move CUT,          EFFECT_ALWAYS_HIT,         90, NORMAL,        100, 30,   0
	...
	move FLY,          EFFECT_FLY,                90, FLYING,        100, 15,   0
	move BIND,         EFFECT_TRAP_TARGET,        25, NORMAL,        75, 20,   0
	move SLAM,         EFFECT_NORMAL_HIT,         80, NORMAL,        95, 20,   0
	...
	move MEGA_KICK,    EFFECT_NORMAL_HIT,        120, NORMAL,        85,  5,   0
	move JUMP_KICK,    EFFECT_JUMP_KICK,          70, FIGHTING,      95, 25,   0
	move ROLLING_KICK, EFFECT_FLINCH_HIT,         80, FIGHTING,      95, 15,  30
	move SAND_ATTACK,  EFFECT_ACCURACY_DOWN,       0, GROUND,       100, 15,   0
	move HEADBUTT,     EFFECT_FLINCH_HIT,         90, NORMAL,       100, 15,  30
	...
	move TACKLE,       EFFECT_NORMAL_HIT,         45, NORMAL,        95, 35,   0
	...
	move THRASH,       EFFECT_RAMPAGE,            110, NORMAL,       100, 20,   0
	...
	move TWINEEDLE,    EFFECT_POISON_MULTI_HIT,   55, BUG,          100, 20,  20
	move PIN_MISSILE,  EFFECT_MULTI_HIT,          24, BUG,           85, 20,   0
	...
	move PSYBEAM,      EFFECT_CONFUSE_HIT,        75, PSYCHIC_TYPE, 100, 20,  10
	...
	move SUBMISSION,   EFFECT_RECOIL_HIT,         80, FIGHTING,      100, 25,   0
	...
	move STRENGTH,     EFFECT_NORMAL_HIT,         100, NORMAL,       100, 15,   0
	...
	move RAZOR_LEAF,   EFFECT_NORMAL_HIT,         85, GRASS,         100, 25,   0
	...
	move FIRE_SPIN,    EFFECT_TRAP_TARGET,        35, FIRE,          70, 15,   0
	...
	move WATERFALL,    EFFECT_NORMAL_HIT,         90, WATER,        100, 15,   0
	...
	move SPIKE_CANNON, EFFECT_MULTI_HIT,          30, NORMAL,       100, 15,   0
	...
	move HI_JUMP_KICK, EFFECT_JUMP_KICK,          125, FIGHTING,      90, 20,   0
	...
	move FLASH,        EFFECT_PARALYZE_HIT,       10, NORMAL,        100, 20,  100
	...
	move ROCK_SLIDE,   EFFECT_FLINCH_HIT,         95, ROCK,          100, 10,  30
	...
	move GIGA_DRAIN,   EFFECT_LEECH_HIT,          80, GRASS,        100,  5,   0
	...
	move FURY_CUTTER,  EFFECT_FURY_CUTTER,        80, BUG,           95, 20,   0
	move STEEL_WING,   EFFECT_DEFENSE_UP_HIT,     90, STEEL,         100, 25,  10
	...
	move DRAGONBREATH, EFFECT_PARALYZE_HIT,       90, DRAGON,       100, 20,  30
	...
	move IRON_TAIL,    EFFECT_DEFENSE_DOWN_HIT,  100, STEEL,         95, 15,  30
	...
	move ANCIENTPOWER, EFFECT_ALL_UP_HIT,         80, ROCK,         100,  5,  10
	move SHADOW_BALL,  EFFECT_SP_DEF_DOWN_HIT,    80, GHOST,        100, 15,  20
	move FUTURE_SIGHT, EFFECT_FUTURE_SIGHT,       80, PSYCHIC_TYPE,  90, 15,   0
	move ROCK_SMASH,   EFFECT_DEFENSE_DOWN_HIT,   100, FIGHTING,     100, 15,  50
	move WHIRLPOOL,    EFFECT_TRAP_TARGET,        95, WATER,         100, 15,   0
	move BEAT_UP,      EFFECT_BEAT_UP,            30, DARK,         100, 10,   0
