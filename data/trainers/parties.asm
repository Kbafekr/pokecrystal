...
PryceGroup:
	...
	db 37, SEEL,       HEADBUTT, ICY_WIND, AURORA_BEAM, REST
	db 39, DEWGONG,    HEADBUTT, ICY_WIND, AURORA_BEAM, REST
	db 38, SNEASEL, HEADBUTT, ICY_WIND, AURORA_BEAM, BEAT_UP
	db 36, DELIBIRD, ICY_WIND, PRESENT, WING_ATTACK, NO_MOVE
...
ChuckGroup:
	...
	db 40, MACHOKE, FORESIGHT, DYNAMICPUNCH, EARTHQUAKE, STRENGTH
	db -1 ; end
