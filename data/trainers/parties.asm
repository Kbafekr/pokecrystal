...
FalknerGroup:
	...
	db  7, PIDGEY,     TACKLE, MUD_SLAP, SAND_ATTACK, NO_MOVE
	db  11, HOOTHOOT,     TACKLE, MUD_SLAP, SAND_ATTACK, NO_MOVE
	db  9, SPEAROW, PECK, MUD_SLAP, SAND_ATTACK, NO_MOVE
...
WhitneyGroup:
	...
	db 16, SNUBBULL,   CHARM, LICK, BITE, TACKLE
	db 20, WIGGLYTUFF, DOUBLESLAP, SING, ROLLOUT, DEFENSE_CURL
...
BugsyGroup:
	...
	db 15, SPINARAK,   SPIDER_WEB, POISON_STING, FURY_CUTTER, NO_MOVE
	db 18, LEDIAN,     COMET_PUNCH, FURY_CUTTER, SUPERSONIC, STRING_SHOT
...
MortyGroup:
	...
	db 28, MISDREAVUS, HYPNOSIS, SHADOW_BALL, CONFUSE_RAY, DREAM_EATER
...
PryceGroup:
	...
	db 38, SEEL,       HEADBUTT, ICY_WIND, AURORA_BEAM, REST
	db 39, DEWGONG,    HEADBUTT, ICY_WIND, AURORA_BEAM, REST
	db 39, SNEASEL, HEADBUTT, ICY_WIND, AURORA_BEAM, BEAT_UP
	db 39, DELIBIRD, ICY_WIND, PRESENT, WING_ATTACK, NO_MOVE
	db 40, LAPRAS, ICY_WIND, BODY_SLAM, SURF, REST
...
JasmineGroup:
	...
	db 36, MAGNETON,  THUNDERBOLT, SUPERSONIC, SONICBOOM, THUNDER_WAVE
	db 36, SKARMORY,  SPIKES, WHIRLWIND, FLY, STEEL_WING
	db 38, FORRETRESS, SPIKES, EXPLOSION, ROLLOUT, DOUBLE_EDGE
	db 38, SCIZOR, SLASH, METAL_CLAW, WING_ATTACK, MEGAHORN
...
ChuckGroup:
	...
	db 35, HITMONTOP, MACH_PUNCH, CROSS_CHOP, TRIPLE_KICK, COUNTER
	db 35, HITMONCHAN, MEGA_PUNCH, FIRE_PUNCH, THUNDERPUNCH, ICE_PUNCH
	db 35, HITMONLEE, MEGA_KICK, HI_JUMP_KICK, ROLLING_KICK, MIND_READER
	db 37, MACHOKE, FORESIGHT, DYNAMICPUNCH, EARTHQUAKE, STRENGTH
...
ClairGroup:
	...
	db 40, DRATINI,  THUNDER_WAVE, EXTREMESPEED, SLAM, TWISTER
	...
	db 43, SEADRA,     SURF, SMOKESCREEN, DRAGONBREATH, WHIRLPOOL
...
Rival1Group:
	...
	db 28, HOUNDOUR,    GROWL, HEADBUTT, BITE, FLAME_WHEEL
	db 26, SNEASEL,     ICY_WIND, BEAT_UP, SLASH, SCREECH
	db -1 ; end
	...
	db 33, MAGNETON,  TACKLE, THUNDERSHOCK, SONICBOOM, THUNDER_WAVE
	db 34, HAUNTER,    LICK, MEAN_LOOK, CURSE, SHADOW_BALL
	db 35, SNEASEL,    LEER, QUICK_ATTACK, SCREECH, FAINT_ATTACK
	db 36, HOUNDOOM,   SLUDGE_BOMB, FLAMETHROWER, IRON_TAIL, CRUNCH
	db -1 ; end
	...
	db 45, HOUNDOOM,   SLUDGE_BOMB, FLAMETHROWER, IRON_TAIL, CRUNCH
	db -1 ; end
...
WillGroup:
	...
	db 50, ESPEON,       QUICK_ATTACK, FUTURE_SIGHT, CONFUSE_RAY, PSYCHIC_M
	...
	db 51, SLOWKING, PSYCHIC_M, SURF, ICE_BEAM, ZAP_CANNON
...
BrunoGroup:
	...
	db 52, HITMONTOP,  TRIPLE_KICK, EXTREMESPEED, EARTHQUAKE, DETECT
	db 52, HITMONLEE,  SWAGGER, MEGA_KICK, HI_JUMP_KICK, FORESIGHT
	db 52, HITMONCHAN, THUNDERPUNCH, ICE_PUNCH, FIRE_PUNCH, CROSS_CHOP
	db 53, STEELIX,       IRON_TAIL, EARTHQUAKE, SANDSTORM, ROCK_SLIDE
	db 55, HERACROSS, MEGAHORN, EARTHQUAKE, CROSS_CHOP, ROCK_SLIDE
	db 56, MACHAMP,    ROCK_SLIDE, EARTHQUAKE, DYNAMICPUNCH, CROSS_CHOP
	db -1 ; end

KarenGroup:
	; KAREN (1)
	db "KAREN@", TRAINERTYPE_MOVES
	db 52, UMBREON,    TOXIC, CONFUSE_RAY, FAINT_ATTACK, MEAN_LOOK
	db 52, VILEPLUME,  TOXIC, SLUDGE_BOMB, MOONLIGHT, PETAL_DANCE
	db 55, GENGAR,     SHADOW_BALL, SLUDGE_BOMB, CURSE, PSYCHIC_M
	db 54, MURKROW,    STEEL_WING, DRILL_PECK, HAZE, FAINT_ATTACK
	db 57, HOUNDOOM,   SOLARBEAM, SLUDGE_BOMB, FLAMETHROWER, CRUNCH
	db 58, UMBREON, TOXIC, CONFUSE_RAY, FAINT_ATTACK, MOONLIGHT
	db -1 ; end
...
KogaGroup:
	...
	db 51, VENOMOTH,   SUPERSONIC, SLUDGE_BOMB, PSYCHIC_M, TOXIC
	db 53, FORRETRESS, PROTECT, SWIFT, EXPLOSION, SPIKES
	db 52, MUK,        MINIMIZE, ACID_ARMOR, SLUDGE_BOMB, TOXIC
	db 52, WEEZING,    MINIMIZE, TOXIC, SLUDGE_BOMB, EXPLOSION
	db 54, CROBAT,     DOUBLE_TEAM, SLUDGE_BOMB, WING_ATTACK, TOXIC
	db -1 ; end

ChampionGroup:
	; CHAMPION (1)
	db "LANCE@", TRAINERTYPE_MOVES
	db 54, GYARADOS,   OUTRAGE, RAIN_DANCE, SURF, HYPER_BEAM
	db 57, DRAGONITE,  THUNDER_WAVE, OUTRAGE, THUNDER, HYPER_BEAM
	db 57, DRAGONITE,  THUNDER_WAVE, OUTRAGE, BLIZZARD, HYPER_BEAM
	db 56, AERODACTYL, WING_ATTACK, ANCIENTPOWER, ROCK_SLIDE, HYPER_BEAM
	db 56, CHARIZARD,  FLAMETHROWER, WING_ATTACK, SLASH, HYPER_BEAM
	db 60, DRAGONITE,  FIRE_BLAST, WING_ATTACK, OUTRAGE, HYPER_BEAM
	db -1 ; end
...
BrockGroup:
	...
	db 51, RHYHORN,    ROCK_SLIDE, MEGAHORN, EARTHQUAKE, BODY_SLAM
	db 52, OMASTAR,    CRUNCH, SURF, ROCK_SLIDE, SPIKE_CANNON
	db 54, ONIX,       IRON_TAIL, ROCK_SLIDE, DRAGONBREATH, SANDSTORM
	db 52, KABUTOPS,   SLASH, SURF, ROCK_SLIDE, GIGA_DRAIN
	db 55, GOLEM,      EXPLOSION, ROCK_SLIDE, EARTHQUAKE, DOUBLE_EDGE
	db -1 ; end

MistyGroup:
	; MISTY (1)
	db "MISTY@", TRAINERTYPE_MOVES
	db 50, CORSOLA, SURF, SPIKE_CANNON, SPIKES, RAIN_DANCE
	...
	db 55, POLITOED, SURF, PERISH_SONG,ICE_BEAM, RAIN_DANCE
...
LtSurgeGroup:
	...
	db 50, LANTURN,    SURF, CONFUSE_RAY, RAIN_DANCE, THUNDER
...
ErikaGroup:
	...
	db 58, SUNFLORA, SUNNY_DAY, SYNTHESIS, SOLARBEAM, PETAL_DANCE
	db 60, VILEPLUME,  SUNNY_DAY, SYNTHESIS, PETAL_DANCE, SOLARBEAM
	db -1 ; end
...
JanineGroup:
	...
	db 52, QWILFISH,   SLUDGE_BOMB, SURF, MINIMIZE, PIN_MISSILE
...
SabrinaGroup:
	...
	db 58, HYPNO,      TOXIC, PSYCHIC_M, HEADBUTT, SHADOW_BALL
...
Rival2Group:
	...
	db 55, HOUNDOOM,   SLUDGE_BOMB, FLAMETHROWER, IRON_TAIL, CRUNCH
	db -1 ; end
	...
	db 60, HOUNDOOM,   SLUDGE_BOMB, FLAMETHROWER, IRON_TAIL, CRUNCH
	db -1 ; end
...
BlaineGroup:
	...
	db 58, FLAREON, FLAMETHROWER, QUICK_ATTACK, FIRE_SPIN, SUNNY_DAY
	db 60, RAPIDASH,   QUICK_ATTACK, FIRE_SPIN, FURY_ATTACK, FIRE_BLAST
	db 60, NINETALES, FIRE_SPIN, FIRE_BLAST, IRON_TAIL, CONFUSE_RAY
	db 62, ARCANINE, CRUNCH, EXTREMESPEED, FIRE_BLAST, IRON_TAIL
	db -1 ; end
...
ExecutiveMGroup:
	...
	db 42, CROBAT,     WING_ATTACK, SLUDGE_BOMB, TOXIC, FAINT_ATTACK
	db 42, WEEZING,    EXPLOSION, SLUDGE_BOMB, DOUBLE_EDGE, HAZE
	db 42, MURKROW,    TOXIC, FAINT_ATTACK, DRILL_PECK, MEAN_LOOK
	db 46, HOUNDOOM,   FLAMETHROWER, SLUDGE_BOMB, CRUNCH, FAINT_ATTACK
	db -1 ; end

	; EXECUTIVEM (2)
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	db 40, CROBAT,     CRUNCH, SLUDGE_BOMB, CONFUSE_RAY, WING_ATTACK
	db 40, MAROWAK, EARTHQUAKE, BONE_CLUB, BONEMERANG, BONE_RUSH
	db 40, PORYGON2, TRI_ATTACK, RECOVER, ZAP_CANNON, LOCK_ON
	db -1 ; end

	; EXECUTIVEM (3)
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	db 34, WEEZING,    DOUBLE_EDGE, EXPLOSION, SLUDGE_BOMB, SMOKESCREEN
	db 34, ARIADOS,    SPIDER_WEB, MEGAHORN, SLUDGE_BOMB, TOXIC
	db 33, GRANBULL,    CRUNCH, HEADBUTT, HYPER_BEAM, CHARM
	db 32, NIDOKING,    EARTHQUAKE, SLUDGE_BOMB, SURF, DOUBLE_EDGE
	db 33, BEEDRILL,    TWINEEDLE, SLUDGE_BOMB, WING_ATTACK, FURY_ATTACK
	db 33, MUK,         SLUDGE_BOMB, TOXIC, MINIMIZE, FIRE_PUNCH
	db -1 ; end
...
ExecutiveFGroup:
	; EXECUTIVEF (1)
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	db 42, ARBOK,      HYPER_BEAM, SLUDGE_BOMB, EARTHQUAKE, GLARE
	db 42, VILEPLUME,  GIGA_DRAIN, SWEET_SCENT, SLEEP_POWDER, SLUDGE_BOMB
	db 42, MURKROW,    DRILL_PECK, FAINT_ATTACK, HAZE, TOXIC
	db 46, NIDOQUEEN,  EARTHQUAKE, BLIZZARD, SLUDGE_BOMB, DOUBLE_EDGE,
	db -1 ; end

	; EXECUTIVEF (2)
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	db 33, ARBOK,      HYPER_BEAM, SLUDGE_BOMB, EARTHQUAKE, GLARE
	db 33, GLOOM,      GIGA_DRAIN, SWEET_SCENT, SLEEP_POWDER, SLUDGE_BOMB
	db 35, MURKROW,    DRILL_PECK, FAINT_ATTACK, HAZE, TOXIC
	db -1 ; end
...
RedGroup:
	...
	db 91, PIKACHU,    SURF, EXTREMESPEED, THUNDERBOLT, IRON_TAIL
	db 85, LAPRAS,     SURF, BLIZZARD, BODY_SLAM, PSYCHIC_M
	db 85, SNORLAX,    EARTHQUAKE, SHADOW_BALL, HYPER_BEAM, REST
	db 87, VENUSAUR,   SUNNY_DAY, SLUDGE_BOMB, SYNTHESIS, SOLARBEAM
	db 87, CHARIZARD,  FLAMETHROWER, WING_ATTACK, SLASH, FIRE_BLAST
	db 87, BLASTOISE,  CRUNCH, SURF, BLIZZARD, SKULL_BASH
	db -1 ; end

BlueGroup:
	; BLUE (1)
	db "BLUE@", TRAINERTYPE_MOVES
	db 66, PIDGEOT,    DRILL_PECK, HYPER_BEAM, STEEL_WING, MIRROR_MOVE
	db 64, ALAKAZAM,   FIRE_PUNCH, ICE_PUNCH, PSYCHIC_M, THUNDERPUNCH
	db 66, RHYDON,     EARTHQUAKE, MEGAHORN, ROCK_SLIDE, DOUBLE_EDGE
	db 68, GYARADOS,   OUTRAGE, HYDRO_PUMP, RAIN_DANCE, HYPER_BEAM
	db 68, EXEGGUTOR,  SUNNY_DAY, PSYCHIC_M, EGG_BOMB, SOLARBEAM
	db 68, ARCANINE,   CRUNCH, FIRE_BLAST, IRON_TAIL, EXTREMESPEED
	db -1 ; end
...
MysticalmanGroup:
	...
	db 33, HYPNO,    DREAM_EATER, HYPNOSIS, TOXIC, PSYCHIC_M
	db 33, GENGAR,    PSYCHIC_M, HYPNOSIS, DREAM_EATER, SHADOW_BALL
	db 33, ELECTRODE,  SWIFT, EXPLOSION, THUNDER, ROLLOUT
	db 33, JUMPLUFF, GIGA_DRAIN, WING_ATTACK, SLEEP_POWDER, LEECH_SEED
	db 35, ALAKAZAM, PSYCHIC_M, THUNDERPUNCH, ICE_PUNCH, FIRE_PUNCH
	db -1 ; end
